...
Below presented summary of viewership and ratings of each season. The table generation was fasten up by Chat GPT. 
...
```{r, changes plot}
friends_changes <- friends_stats %>%
  mutate(change = viewers_millions - lag(viewers_millions)) %>%
  filter(!is.na(change))
